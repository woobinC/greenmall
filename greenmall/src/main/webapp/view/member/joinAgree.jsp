...
const strong_none = () =>{
	let agreebox1 = $("#agree_box1");
	let agreebox2 = $("#agree_box2");
	if(agreebox1.prop("checked")){
		$(".important_check strong:first").hide();
	}
	if(agreebox2.prop("checked")){
		$(".important_check strong:last").hide();
	}
                ...
                <div class="member_title">
                    ...
                    <ol>
                        <li class="page_on"><span> 01 </span>약관동의 <span><img
                                    src="https://cdn-pro-web-250-117.cdn-nhncommerce.com/moddism_godomall_com/data/skin/front/moment/img/member/icon_join_step_on.png"
                                    alt=""> </span></li>
                        ...
                        <div class="join_agree_cont">
                            <div class="join_agree_box">
                                <div class="form_element">
                                    ...
                                    <label for="allAgree" class="check">
                                        <em>그린몰의 모든 약관을 확인하고 전체 동의합니다.</em>
                                    </label>
                                    <span>(전체동의, 선택항목도 포함됩니다.)</span>
                                </div>
                            </div>
                            <div class="join_agree_box content_agree">
                                <div class="form_element">
                                    <input type="checkbox" required class="required" id="agree_box1" onclick="strong_none()">
                                    <label for="agree_box1" class="check_s">
                                        <strong>(필수)</strong>
                                        이용약관
                                    </label>
                                </div>
                                <div class="agreementBox">
                                    ...
                                    <br>
                                    <br>
                                    이 약관은 익산시청 회사(전자거래 사업자)가 운영하는 익산몰 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라
                                    ...
                                    <br>
                                    <br>
                                    ① "몰"이란 익산시청 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한
                            ...
                            <div class="join_agree_box content_agree">
                                <div class="form_element">
                                    <input type="checkbox" required class="required" id="agree_box2" onclick="strong_none()">
                                    <label for="agree_box2" class="check_s">
                                        <strong>(필수)</strong>
                                        개인정보 수집 및 이용
                                    </label>
                                </div>
                            ...
                            <div class="important_check">
                                <strong style="display: none">(필수) 이용약관을 체크해주세요.</strong>
                                <strong style="display: none">(필수) 개인정보 수집 및 이용을 체크해주세요.</strong>
                            </div>
                        </div>
